...
The repository contains two high-resolution WebP frame sequences under `public/`:
- `public/Kunafa-animations-v2/` (100 widescreen WebP frames, `1280x720`, ~4.3MB total): Desktop scrollytelling explosion sequence.
- `public/mobile-view-framesv2/` (130 portrait WebP frames, `720x1280`, ~8.7MB total): Mobile-optimized vertical levitation and explosion sequence.
