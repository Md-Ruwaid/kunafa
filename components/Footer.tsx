...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#030303]/80 backdrop-blur-md text-[#FFF8EC] border-t border-white/10 pt-16 sm:pt-20 pb-10 sm:pb-12 px-4 sm:px-8 relative overflow-hidden">
