...
export default function MenuPreview() {
  return (
    <section className="py-28 px-4 sm:px-8 bg-[#030303] text-white border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Cards — brand showcase only, no CTAs */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {MENU_ITEMS.map((item) => (
            <div
              key={item.id}
              className="group bg-[#241509]/60 hover:bg-[#241509] border border-[#E7DCC9]/15 hover:border-[#EFB80D]/40 rounded-[20px] p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
            >
              ...
              <h3 className="font-display font-semibold text-lg text-[#FFF8EC] group-hover:text-[#EFB80D] transition-colors leading-snug mb-2">
                {item.name}
              </h3>
              ...
              <div className="pt-3 border-t border-white/5 font-mono text-[10px] text-[#7A6A5B]">
                {item.specs}
              </div>
            </div>
          ))}
        ...
        {/* Catering callout — brand only */}
        <div id="catering" className="p-6 sm:p-10 rounded-[20px] bg-[#241509] border border-[#EFB80D]/20 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="font-sans text-xs text-[#B3A697] mt-0.5">
          ...
          <a
            ...
            className="shrink-0 font-mono text-xs uppercase tracking-wider text-[#EFB80D] border border-[#EFB80D]/40 hover:border-[#EFB80D] hover:bg-[#EFB80D]/10 px-6 py-3 rounded-full transition-all focus-visible:outline-2 focus-visible:outline-[#EFB80D]"
          >
            GET IN TOUCH
          </a>
        </div>
