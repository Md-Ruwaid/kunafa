...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="relative z-30 -mt-[50vh] sm:-mt-[45vh] min-h-screen flex flex-col justify-center items-center py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#050505] text-[#FFF8EC] rounded-t-2xl sm:rounded-t-3xl border-t-2 border-[#EFB80D]/40 shadow-[0_-50px_120px_rgba(0,0,0,1)] will-change-[box-shadow]"
    >
