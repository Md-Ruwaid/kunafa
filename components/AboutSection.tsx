...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="py-20 sm:py-28 px-4 sm:px-8 bg-white border-t border-[#E7DCC9] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="font-sans text-xs sm:text-base text-[#7A6A5B] leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch mb-14 sm:mb-20">
          ...
          <div className="lg:col-span-6 bg-[#FFF8EC] border border-[#E7DCC9] rounded-[20px] sm:rounded-[24px] p-5 sm:p-9 shadow-sm relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center gap-3.5 sm:gap-4 mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#2B1B12] border-2 border-[#EFB80D] flex items-center justify-center text-[#EFB80D] font-display font-bold text-xl sm:text-2xl shrink-0 shadow-md">
                  S
                </div>
                <div>
                  <div className="font-display font-bold text-lg sm:text-xl text-[#2B1B12]">
                    Saud bin Nasar Khulagi
                  </div>
                  <div className="font-mono text-[11px] sm:text-xs text-[#DA7034] uppercase tracking-wider font-semibold">
                    Founder &amp; Recipe Maestro
                  </div>
                  <div className="font-mono text-[9px] sm:text-[10px] text-[#7A6A5B]">
                    Barkas, Hyderabad · Est. 2021
                  </div>
                </div>
              </div>

              <div className="space-y-3.5 font-sans text-xs sm:text-sm text-[#7A6A5B] leading-relaxed border-t border-[#E7DCC9] pt-5">
                <p>
            ...
            <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-[#E7DCC9] flex items-center justify-between">
              <CaptainSeal />
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex flex-col justify-between gap-3 sm:gap-4">
            {craftPillars.map((pillar, idx) => (
              <div
                key={idx}
                className="bg-white border border-[#E7DCC9] rounded-[18px] sm:rounded-[22px] p-5 sm:p-7 hover:border-[#DA7034]/50 hover:shadow-md transition-all flex-1 flex flex-col justify-center"
              >
                <div className="flex items-center gap-2.5 sm:gap-3 mb-1.5 sm:mb-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#FFF8EC] border border-[#EFB80D]/40 flex items-center justify-center font-mono text-[11px] sm:text-xs font-bold text-[#DA7034] shrink-0">
                    0{idx + 1}
                  </div>
                  <h3 className="font-display font-bold text-base sm:text-lg text-[#2B1B12]">
                    {pillar.title}
                  </h3>
                </div>
                <p className="font-sans text-xs sm:text-sm text-[#7A6A5B] leading-relaxed pl-9 sm:pl-11">
                  {pillar.desc}
                </p>
              </div>
            ))}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
          {stats.map(({ value, label, sub, icon: Icon }, idx) => (
            <div
              key={idx}
              className="p-4 sm:p-6 bg-[#FFF8EC] border border-[#E7DCC9] rounded-[16px] sm:rounded-[20px] hover:border-[#EFB80D]/50 hover:shadow-md transition-all text-center"
            >
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-white border border-[#EFB80D]/40 flex items-center justify-center mx-auto mb-2 sm:mb-3 text-[#DA7034] shadow-sm">
                <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
              </div>
              <div className="font-display text-2xl sm:text-4xl font-bold text-[#2B1B12] mb-0.5">
                {value}
              </div>
              <div className="font-mono text-[10px] sm:text-xs uppercase tracking-wider text-[#DA7034] font-semibold">
                {label}
              </div>
              <div className="font-mono text-[9px] sm:text-[10px] text-[#7A6A5B] mt-0.5">
                {sub}
              </div>
            </div>
          ))}
