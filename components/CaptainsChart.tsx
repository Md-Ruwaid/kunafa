...
export default function CaptainsChart() {
  ...
  useEffect(() => {
    ...
    const renderLoop = () => {
      ...
      // Update Ship Coordinates directly on SVG DOM
      ...
      // Update HUD progress text without triggering React component re-render
      const percent = Math.round(currentProgress * 100);
      if (hudPercentRef.current) {
        hudPercentRef.current.textContent = `(${percent}% SAILED)`;
      }

      // Calculate discrete active port (0 to 4)
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col justify-between p-4 sm:p-6 lg:p-8 overflow-hidden bg-[#FFF8EC]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full pt-16 sm:pt-14">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 mb-3">
            <div className="text-center md:text-left">
              <div className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.25em] text-[#DA7034] bg-[#DA7034]/10 border border-[#DA7034]/25 px-3.5 py-1 rounded-full mb-1 font-semibold">
            ...
            <div className="flex items-center gap-3 bg-white border border-[#E7DCC9] px-4 py-2 rounded-full shadow-sm">
              ...
              <span className="font-mono text-xs font-bold text-[#2B1B12]">
                ANCHOR: <span ref={hudProgressRef} className="text-[#DA7034] uppercase">{OUTLETS[0].name}</span>
              </span>
              <span ref={hudPercentRef} className="font-mono text-[11px] text-[#7A6A5B]">
                (0% SAILED)
              </span>
            </div>
          </div>
          ...
          {/* Stepper Navigation */}
          <div className="grid grid-cols-5 gap-1.5 sm:gap-2.5 bg-white/85 border border-[#E7DCC9] p-1.5 rounded-2xl shadow-sm backdrop-blur-sm">
          ...
          <div className="lg:col-span-7 bg-white border-2 border-[#E7DCC9] rounded-[24px] p-4 sm:p-6 shadow-md relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative w-full h-[220px] sm:h-[280px] select-none">
              ...
              >
                ...
                {/* Sailing Vessel Group (Interpolated via direct RAF) */}
                <g ref={shipGroupRef}>
            ...
            <div className="pt-2 border-t border-[#E7DCC9]/60 flex items-center justify-between font-mono text-[10px] text-[#7A6A5B]">
              ...
              <span className="text-[#DA7034] font-bold">
                {activePortIndex === OUTLETS.length - 1
                  ...
                  : `➔ NEXT: ${OUTLETS[activePortIndex + 1]?.name}`}
              </span>
            </div>
          </div>

          {/* Active Port Spotlight Card (5 cols) */}
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="font-mono text-xs font-bold text-white bg-[#DA7034] px-3 py-1 rounded-full uppercase tracking-wider">
                    {activeOutlet.code} · STOP 0{activePortIndex + 1} OF 05
                  </span>
                ...
                <div className="inline-block bg-[#2B1B12] text-[#EFB80D] font-mono text-[11px] px-3.5 py-1.5 rounded-lg font-medium mb-3.5">
                  {activeOutlet.highlight}
                </div>

                <p className="font-sans text-xs sm:text-sm text-[#7A6A5B] leading-relaxed mb-4">
                  {activeOutlet.description}
                </p>

                <div className="space-y-2 font-sans text-xs text-[#7A6A5B] border-t border-[#E7DCC9] pt-3.5 mb-5">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-mono text-[11px]">{activeOutlet.hours}</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Phone className="w-4 h-4 text-[#DA7034] shrink-0" />
                    <span className="font-mono text-[11px]">{activeOutlet.phone}</span>
                  </div>
                </div>
        ...
        {/* 3. Bottom Guide */}
        <div className="relative z-10 max-w-7xl mx-auto w-full pb-1 flex items-center justify-between font-mono text-[11px] text-[#7A6A5B]">
