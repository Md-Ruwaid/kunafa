    ...
    >
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-1">
          {navLinks.map((link) => (
            <button
              ...
              className="font-sans text-xs uppercase tracking-wider px-3.5 py-1.5 rounded-md text-white hover:text-[#000000] hover:bg-[#EFB80D] font-semibold transition-all duration-150 cursor-pointer focus-visible:outline-2 focus-visible:outline-[#EFB80D]"
            >
              {link.label}
            </button>
          ))}
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 btn-tactile-gold font-sans font-bold text-xs px-3.5 py-2 rounded-md"
          >
      ...
      {mobileOpen && (
        <>
          ...
          />
          <div className="md:hidden relative z-50 mt-2 max-w-xs sm:max-w-sm mx-auto bg-[#111111] border border-[#EFB80D]/40 rounded-xl p-3 flex flex-col gap-1 shadow-2xl">
            {navLinks.map((link) => (
              <button
                key={link.href}
                type="button"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-1 flex items-center justify-center gap-2 btn-tactile-gold font-sans font-bold text-xs py-3 rounded-lg w-full"
            >
              Order on WhatsApp
            </a>
          </div>
